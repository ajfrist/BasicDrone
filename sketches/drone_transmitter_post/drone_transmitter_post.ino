...
const int JOYSTICK_PIN_X1 = A1;
const int JOYSTICK_PIN_Y1 = A2;
const int JOYSTICK_PIN_X2 = A3;
const int JOYSTICK_PIN_Y2 = A4;
const int THROTTLE_PIN = A5;
...
// int UP_PIN = 5;
// int DOWN_PIN = 6;
const int TRIM_TOGGLE_PIN = 7;
const int TRIM_LED_PIN = 8;
const int POWER_TOGGLE_PIN = 4;
...
void loop() {
  ...
  // Joysticks domain from [0, 1023], centered at 511
  LoRa.beginPacket();
  LoRa.write(analogRead(THROTTLE_PIN));
  // LoRa.write(analogRead(SWITCH_PIN1));
  // LoRa.write(analogRead(SWITCH_PIN2));
  LoRa.write(digitalRead(TRIM_TOGGLE_PIN));
  LoRa.write(digitalRead(POWER_TOGGLE_PIN));
